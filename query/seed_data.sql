...
INSERT INTO skill (skill_name, skill_category, search_tokens) VALUES
    -- Programming Languages
    ('Python',              'hard_skill', 'python py scripting automation data'),
    ('JavaScript',          'hard_skill', 'javascript js es6 ecmascript web browser'),
    ('TypeScript',          'hard_skill', 'typescript ts typed javascript'),
    ('Java',                'hard_skill', 'java jvm oop object oriented enterprise'),
    ('Kotlin',              'hard_skill', 'kotlin android jvm multiplatform'),
    ('Swift',               'hard_skill', 'swift ios apple macos xcode'),
    ('Go',                  'hard_skill', 'go golang concurrent backend systems'),
    ('PHP',                 'hard_skill', 'php web server scripting wordpress'),
    ('Ruby',                'hard_skill', 'ruby rails rb scripting'),
    ('C++',                 'hard_skill', 'c++ cpp systems programming game'),
    ('C#',                  'hard_skill', 'c# csharp dotnet net microsoft unity'),
    ('Dart',                'hard_skill', 'dart flutter mobile cross platform'),
    ('Rust',                'hard_skill', 'rust systems memory safe concurrent'),
    -- Backend Frameworks & APIs
    ('FastAPI',             'hard_skill', 'fastapi python async api framework'),
    ('Django',              'hard_skill', 'django python web framework orm fullstack'),
    ('Flask',               'hard_skill', 'flask python microframework lightweight api'),
    ('Node.js',             'hard_skill', 'nodejs node javascript backend runtime server'),
    ('Express.js',          'hard_skill', 'express expressjs nodejs web framework api'),
    ('Spring Boot',         'hard_skill', 'spring springboot java enterprise microservice'),
    ('Laravel',             'hard_skill', 'laravel php web framework mvc'),
    ('REST API',            'hard_skill', 'rest restful api http endpoint web service json'),
    ('GraphQL',             'hard_skill', 'graphql api query mutation schema subscription'),
    -- Frontend Frameworks & Libraries
    ('React',               'hard_skill', 'react reactjs javascript frontend ui component library'),
    ('Vue.js',              'hard_skill', 'vue vuejs javascript frontend progressive framework'),
    ('Angular',             'hard_skill', 'angular angularjs typescript spa framework'),
    ('Next.js',             'hard_skill', 'nextjs next react ssr ssg static fullstack'),
    ('HTML/CSS',            'hard_skill', 'html css markup styling web layout responsive'),
    ('Tailwind CSS',        'hard_skill', 'tailwind tailwindcss css utility class styling'),
    -- Mobile
    ('Flutter',             'hard_skill', 'flutter dart mobile cross platform ios android'),
    ('React Native',        'hard_skill', 'react native rn mobile cross platform javascript ios android'),
    ('Android Development', 'hard_skill', 'android java kotlin mobile app google play'),
    ('iOS Development',     'hard_skill', 'ios swift objective-c apple mobile iphone app store'),
    -- Databases
    ('PostgreSQL',          'hard_skill', 'postgresql postgres relational database sql'),
    ('MySQL',               'hard_skill', 'mysql relational database sql'),
    ('MongoDB',             'hard_skill', 'mongodb nosql document database'),
    ('Redis',               'hard_skill', 'redis cache in-memory key-value session'),
    ('Firebase',            'hard_skill', 'firebase google realtime database auth storage'),
    ('Supabase',            'hard_skill', 'supabase postgres open source backend-as-a-service'),
    ('SQL',                 'hard_skill', 'sql query database structured relational'),
    -- DevOps & Cloud
    ('Docker',              'hard_skill', 'docker container containerization image devops'),
    ('Kubernetes',          'hard_skill', 'kubernetes k8s orchestration container cluster'),
    ('AWS',                 'hard_skill', 'aws amazon web services cloud ec2 s3 lambda'),
    ('GCP',                 'hard_skill', 'gcp google cloud platform compute storage'),
    ('Azure',               'hard_skill', 'azure microsoft cloud devops'),
    ('CI/CD',               'hard_skill', 'cicd continuous integration deployment pipeline devops github actions'),
    ('Linux',               'hard_skill', 'linux unix bash shell server command line'),
    ('Git',                 'tool',       'git version control github gitlab branching'),
    -- Data & AI / ML
    ('Machine Learning',    'hard_skill', 'machine learning ml ai artificial intelligence model training'),
    ('Data Analysis',       'hard_skill', 'data analysis analytics statistics insight visualization'),
    ('TensorFlow',          'hard_skill', 'tensorflow tf deep learning neural network google'),
    ('PyTorch',             'hard_skill', 'pytorch torch deep learning neural network'),
    ('Pandas',              'hard_skill', 'pandas python data manipulation dataframe analysis'),
    ('Power BI',            'tool',       'power bi microsoft business intelligence dashboard report'),
    ('Tableau',             'tool',       'tableau data visualization dashboard analytics'),
    -- Design
    ('UI/UX Design',        'hard_skill', 'user interface experience ux ui design usability heuristics'),
    ('Graphic Design',      'hard_skill', 'graphic design visual branding layout composition'),
    ('Wireframing',         'hard_skill', 'wireframe mockup low fidelity sketch layout design'),
    ('Prototyping',         'hard_skill', 'prototype interactive clickable high fidelity design'),
    ('Figma',               'tool',       'figma design ui prototype collaboration auto layout'),
    ('Adobe XD',            'tool',       'adobe xd design prototype ui ux'),
    ('Sketch',              'tool',       'sketch design mac ui vector'),
    ('Photoshop',           'tool',       'photoshop adobe photo editing image manipulation raster'),
    ('Illustrator',         'tool',       'illustrator adobe vector graphic logo illustration'),
    ('After Effects',       'tool',       'after effects adobe motion graphics animation compositing'),
    ('Premiere Pro',        'tool',       'premiere pro adobe video editing cutting color'),
    -- Writing & Marketing
    ('Copywriting',         'hard_skill', 'copywriting copy content persuasive writing ads'),
    ('SEO',                 'hard_skill', 'seo search engine optimization keywords ranking google'),
    ('Content Writing',     'hard_skill', 'content writing blog article editorial'),
    ('Social Media Marketing', 'hard_skill', 'social media instagram tiktok facebook marketing posting'),
    ('Digital Marketing',   'hard_skill', 'digital marketing online ads campaign paid email'),
    -- Project Tools
    ('Jira',                'tool',       'jira project management agile scrum sprint tickets'),
    ('Notion',              'tool',       'notion notes wiki docs productivity workspace'),
    ('Trello',              'tool',       'trello kanban board task card management'),
    ('Postman',             'tool',       'postman api testing rest client http'),
    -- Soft Skills
    ('Communication',       'soft_skill', 'communication verbal written interpersonal presentation'),
    ('Problem Solving',     'soft_skill', 'problem solving analytical thinking debugging'),
    ('Teamwork',            'soft_skill', 'teamwork collaboration team cooperation'),
    ('Leadership',          'soft_skill', 'leadership managing team lead mentor'),
    ('Project Management',  'soft_skill', 'project management planning coordination delivery'),
    ('Time Management',     'soft_skill', 'time management deadline scheduling productivity'),
    ('Critical Thinking',   'soft_skill', 'critical thinking analysis reasoning logic'),
    ('Adaptability',        'soft_skill', 'adaptability flexible learning agile change'),
    ('Creativity',          'soft_skill', 'creativity creative ideas innovation design thinking'),
    ('Attention to Detail', 'soft_skill', 'attention detail precise accurate quality review')
